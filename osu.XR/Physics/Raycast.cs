...
namespace osu.XR.Physics {
	public static class Raycast {
		...
		/// </summary>
		public static bool TryHit ( Vector3 origin, Vector3 direction, Vector3 pointOnPlane, Vector3 planeNormal, out RaycastHit hit, bool includeBehind = false ) { // BUG something is wrong on flat Y+ planes
