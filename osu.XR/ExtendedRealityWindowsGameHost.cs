...
namespace osu.XR {
	public class ExtendedRealityWindowsGameHost : GameHost { // this is a copy of DesktopGameHost and WindowsGameHost
        ...
        public ExtendedRealityWindowsGameHost ( string gameName = @"", bool bindIPCPort = false, ToolkitOptions toolkitOptions = default, bool portableInstallation = false )
        ...
        public void Run<T> ( T game ) where T : Framework.Game, IXrGame {
            base.Run( game );
		}
